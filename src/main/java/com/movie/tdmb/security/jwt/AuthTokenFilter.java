    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                Date passwordChangedAt = jwtUtils.getPasswordChangedAtFromJwtToken(jwt);
                if (userDetails instanceof UserDetailsImpl) {
                    UserDetailsImpl customUserDetails = (UserDetailsImpl) userDetails;
                    if (passwordChangedAt.before(customUserDetails.getPasswordChangedAt())) {
                        throw new Exception("Password has been changed. Please login again");
                    }
                }
